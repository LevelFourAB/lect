...
public class TokenizingLanguageTest
{
	...
	public void testSimple()
	{
		...
		encounter.verifyToken(TokenType.UNKNOWN, Location.text(0, 0), Location.text(0, 5), "Hello");
		encounter.verifyToken(TokenType.WHITESPACE, Location.text(0, 5), Location.text(0, 6), " ");
		encounter.verifyToken(TokenType.UNKNOWN, Location.text(0, 6), Location.text(0, 12), "world!");
	...
	public void testMultipleSentences()
	{
		...
		encounter.verifyToken(TokenType.UNKNOWN, Location.text(0, 13), Location.text(0, 18), "Hello");
		encounter.verifyToken(TokenType.WHITESPACE, Location.text(0, 18), Location.text(0, 19), " ");
		encounter.verifyToken(TokenType.UNKNOWN, Location.text(0, 19), Location.text(0, 27), "cookies.");
